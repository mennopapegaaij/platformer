...
def teken_portaal_icoon(soort, cx, cy):
    ...
    if soort == "vlucht":
    ...
    elif soort == "elementkoning":
        # Een kroontje met gekleurde bolletjes eronder
        arcade.draw_polygon_filled([(cx - 9, cy), (cx + 9, cy), (cx + 9, cy + 7), (cx + 5, cy + 3),
    ...
    elif soort == "drakentemmer":
        # Een drakenei met een barstje
        arcade.draw_ellipse_filled(cx, cy, 14, 18, (245, 240, 220))
        ...
        # Vier verfdruppels in de vier kleuren
        for (dx, dy), kl in zip(((-5, 5), (5, 5), (-5, -5), (5, -5)),
                                ((60, 140, 255), (235, 60, 50), (70, 200, 80), (250, 215, 40))):
            arcade.draw_circle_filled(cx + dx, cy + dy, 4, kl)
            arcade.draw_triangle_filled(cx + dx - 3, cy + dy + 1, cx + dx + 3, cy + dy + 1,
                                        cx + dx, cy + dy + 7, kl)
    elif soort == "chemicus":
        # Een kolf met gekleurd drankje en een bubbel
        arcade.draw_circle_filled(cx, cy - 3, 8, (230, 240, 245))
        ...
        # Een fabriekje met een schoorsteen
        arcade.draw_lrbt_rectangle_filled(cx - 10, cx + 10, cy - 8, cy + 2, (250, 200, 30))
        arcade.draw_triangle_filled(cx - 10, cy + 2, cx - 3, cy + 2, cx - 10, cy + 7, (250, 200, 30))
        arcade.draw_triangle_filled(cx - 3, cy + 2, cx + 4, cy + 2, cx - 3, cy + 7, (250, 200, 30))
        arcade.draw_lrbt_rectangle_filled(cx + 5, cx + 9, cy + 2, cy + 11, (250, 200, 30))
    elif soort == "eigen":
